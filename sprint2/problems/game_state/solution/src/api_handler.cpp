...
json::object ApiHandler::MakeRoadJson(const model::Road& road) {
    json::object j;
...
json::object ApiHandler::MakeBuildingJson(const model::Building& building) {
...
json::object ApiHandler::MakeOfficeJson(const model::Office& o) {
    return {
        {"id", *o.GetId()},
        {"x", o.GetPosition().x},
        {"y", o.GetPosition().y},
...
json::object ApiHandler::MakeMapJson(const model::Map& map) {
    json::object j;
    j["id"] = *map.GetId();
    j["name"] = map.GetName();
...
json::array ApiHandler::MakeMapsJson() {
    json::array arr;
